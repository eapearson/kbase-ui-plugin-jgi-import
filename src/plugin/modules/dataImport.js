...
define([
    ...
    'kb/service/utils',
    'text!./text/new-narrative-with-data-intro.md'
], function (
    Promise,
    html,
    domEvent,
                ...
                div({class: 'row'}, [
                    div({class: 'col-md-6'}, [
                        div({dataElement: 'copy-to-new-narrative'}, [
                            ...
                            p('Use this tool to copy the JGI import object into a new Narrative, which will be created on the fly and opened in a new browser window.'),
